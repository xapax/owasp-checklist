...
### 1.1 - [ ] - Browser entire application while in burp
### 1.2 - [ ] - Consult Public Sources
        [ ] - Google
        ...
        ```
        [ ] - Bing
        [ ] - WayBackMachine - Other stuff
### 1.3 - [ ] - Discover Hidden Content (use burp)
...
### 1.6 - [ ] - Test for Debug Parameters
            [ ] - Test debug=true in URLs - Use cluster-bomb attack in Burp
            debug       true
            test        yes
            hide        1
            source      on
### 2.0 - [ ] - Analyze the Application
...
### 4.0 [ ] - Test the Autentication Mechanism
            ...
            [ ] - Test Predictibility of Autogenerated Credentials
                If usernames and passwords are autogenerated see if they are generated in a predictable way.
...
### 5.0 [ ] - Test the Session Management Mechnaism
